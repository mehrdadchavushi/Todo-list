    ...
    (function (e) {
      e.exports = (function () {
        ...
        function v(e, t) {
          ...
          return l(function () {
            if (
              (null != n.deprecationHandler && n.deprecationHandler(null, e), a)
            ) {
        ...
        function V(e, t) {
          ...
          for (C.lastIndex = 0; a >= 0 && C.test(e); )
            (e = e.replace(C, s)), (C.lastIndex = 0), (a -= 1);
          return e;
        }
        var B = /\d/,
          Z = /\d\d/,
        ...
        function be(e, t) {
          return function (a) {
            return null != a
              ? (Oe(this, e, a), n.updateOffset(this, t), this)
              : xe(this, e);
          };
        }
        function xe(e, t) {
        ...
        function ze(e) {
          return null != e
            ? (Ee(this, e), n.updateOffset(this, !0), this)
            : xe(this, "Month");
        }
        var Je = _e,
          Ne = _e;
        ...
        function Ge(e, t, a) {
          ...
          return (
            i < 1
              ? ((n = e.year() - 1), (s = i + Ve(n, t, a)))
              : i > Ve(e.year(), t, a)
              ? ((s = i - Ve(e.year(), t, a)), (n = e.year() + 1))
              : ((n = e.year()), (s = i)),
            { week: s, year: n }
          );
        }
        ...
        function et() {
          ...
          for (i.sort(e), d.sort(e), _.sort(e), o.sort(e), t = 0; t < 7; t++)
            (d[t] = le(d[t])), (_[t] = le(_[t])), (o[t] = le(o[t]));
          ...
          return (
            a &&
              ...
              ((t =
                a[ye] < 0 || a[ye] > 11
                  ? ye
                  : a[fe] < 1 || a[fe] > Pe(a[Ye], a[ye])
                  ? fe
                  : a[De] < 0 ||
                    a[De] > 24 ||
                    (24 === a[De] &&
                      (0 !== a[pe] || 0 !== a[ke] || 0 !== a[Te]))
                  ? De
                  : a[pe] < 0 || a[pe] > 59
                  ? pe
                  : a[ke] < 0 || a[ke] > 59
                  ...
                  ? Te
                  : -1),
              c(e)._overflowDayOfYear && (t < Ye || t > fe) && (t = fe),
              c(e)._overflowWeeks && -1 === t && (t = ge),
              c(e)._overflowWeekday && -1 === t && (t = we),
              (c(e).overflow = t)),
            e
          );
        }
                ...
                e._w &&
                  ...
                  (function (e) {
                    ...
                    if (null != (t = e._w).GG || null != t.W || null != t.E)
                      (r = 1),
                        (i = 4),
                        (a = Mt(t.GG, e._a[Ye], Ge(xt(), 1, 4).year)),
                        (s = Mt(t.W, 1)),
                        ((n = Mt(t.E, 1)) < 1 || n > 7) && (_ = !0);
                    else {
            ...
            if (
              !(function (e, t, a) {
                if (e) {
                  ...
                  if (s !== n)
                    return (c(a).weekdayMismatch = !0), (a._isValid = !1), !1;
                }
                return !0;
              })(_[1], o, e)
            )
          ...
          if (e._f !== n.ISO_8601)
            if (e._f !== n.RFC_2822) {
              ...
              var t,
                ...
                o = 0;
              for (
                s = V(e._f, e._locale).match(N) || [], t = 0;
                t < s.length;
                t++
              )
                (r = s[t]),
                  (a = (d.match(me(r, e)) || [])[0]) &&
                    ...
                    (o += a.length)),
                  R[r]
                    ? (a ? (c(e).empty = !1) : c(e).unusedTokens.push(r),
                      Le(r, a, e))
                    : e._strict && !a && c(e).unusedTokens.push(r);
              (c(e).charsLeftOver = _ - o),
                d.length > 0 && c(e).unusedInput.push(d),
                e._a[De] <= 12 &&
                  !0 === c(e).bigHour &&
                  e._a[De] > 0 &&
                  (c(e).bigHour = void 0),
        ...
        function It(e, t) {
          ...
          return t._isUTC
            ? ((a = t.clone()),
              (s =
                (p(e) || o(e) ? e.valueOf() : xt(e).valueOf()) - a.valueOf()),
          ...
          return (
            Et(e)
              ...
              : "object" == typeof o &&
                ...
                (n =
                  r.isValid() && i.isValid()
                    ? ((i = It(i, r)),
                      r.isBefore(i)
                        ? (d = Kt(r, i))
                        : (((d = Kt(i, r)).milliseconds = -d.milliseconds),
                          (d.months = -d.months)),
                      d)
                ...
                (o.M = n.months)),
            (s = new Ft(o)),
            Et(e) && m(e, "_locale") && (s._locale = e._locale),
            s
          );
        }
        function Zt(e, t) {
          ...
          return function (a, s) {
            ...
            return (
              null === s ||
                ...
                (a = s),
                (s = n)),
              qt(this, Bt((a = "string" == typeof a ? +a : a), s), e),
              this
            );
          };
        }
        ...
        function ea(e, t) {
          ...
          return (
            t - r < 0
              ? ((a = e.clone().add(n - 1, "months")), (s = (t - r) / (r - a)))
              : ((a = e.clone().add(n + 1, "months")), (s = (t - r) / (a - r))),
            -(n + s) || 0
          );
        }
        function ta(e) {
        ...
        U(0, ["gg", 2], 0, function () {
          ...
          ue("GGGGG", se, q),
          ue("ggggg", se, q),
          Me(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, a, s) {
            t[s.substr(0, 2)] = T(e);
          }),
        ...
        (fa.add = Qt),
          ...
          (fa.diff = function (e, t, a) {
            ...
            switch (
              ((n = 6e4 * (s.utcOffset() - this.utcOffset())), (t = A(t)))
            ) {
              case "year":
                r = ea(this, s) / 12;
                break;
            ...
            switch (e) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t +=
                    ia -
                    _a(t + (this._isUTC ? 0 : this.utcOffset() * ra), ia) -
                    1);
                break;
              case "minute":
          ...
          (fa.set = function (e, t) {
            if ("object" == typeof e)
              for (
                var a = (function (e) {
                    var t = [];
                    for (var a in e) t.push({ unit: a, priority: E[a] });
                    return (
                      t.sort(function (e, t) {
          ...
          (fa.startOf = function (e) {
            ...
            switch (e) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t -= _a(t + (this._isUTC ? 0 : this.utcOffset() * ra), ia));
                break;
              case "minute":
          ...
          (fa.hour = fa.hours = rt),
          (fa.minute = fa.minutes = ca),
          (fa.second = fa.seconds = La),
          (fa.millisecond = fa.milliseconds = ya),
          (fa.utcOffset = function (e, t, a) {
            var s,
              r = this._offset || 0;
            if (!this.isValid()) return null != e ? this : NaN;
            if (null != e) {
          ...
          (fa.isUtc = Ut),
          (fa.isUTC = Ut),
          (fa.zoneAbbr = function () {
            return this._isUTC ? "UTC" : "";
          }),
          (fa.zoneName = function () {
            return this._isUTC ? "Coordinated Universal Time" : "";
          }),
          (fa.dates = v("dates accessor is deprecated. Use date instead.", ha)),
          (fa.months = v(
            "months accessor is deprecated. Use month instead",
            ze
          )),
          (fa.years = v("years accessor is deprecated. Use year instead", He)),
          (fa.zone = v(
        ...
        (pa.calendar = function (e, t, a) {
          ...
          (pa.preparse = Da),
          (pa.postformat = Da),
          (pa.relativeTime = function (e, t, a, s) {
          ...
          (pa.monthsParse = function (e, t, a) {
            ...
            if (this._monthsParseExact)
              return function (e, t, a) {
                ...
                return a
                  ? "MMM" === t
                    ? -1 !== (n = Se.call(this._shortMonthsParse, i))
                      ? n
                      : null
                    : -1 !== (n = Se.call(this._longMonthsParse, i))
                    ? n
                    : null
                  : "MMM" === t
                  ? -1 !== (n = Se.call(this._shortMonthsParse, i))
          ...
          (pa.monthsRegex = function (e) {
            return this._monthsParseExact
              ...
              : (m(this, "_monthsRegex") || (this._monthsRegex = Ne),
          ...
          (pa.monthsShortRegex = function (e) {
            return this._monthsParseExact
              ...
              : (m(this, "_monthsShortRegex") || (this._monthsShortRegex = Je),
          ...
          (pa.weekdaysParse = function (e, t, a) {
            ...
            if (this._weekdaysParseExact)
              return function (e, t, a) {
                ...
                return a
                  ? "dddd" === t
                    ? -1 !== (n = Se.call(this._weekdaysParse, i))
                      ? n
                      : null
                    : "ddd" === t
                    ? -1 !== (n = Se.call(this._shortWeekdaysParse, i))
                      ? n
                      : null
                    : -1 !== (n = Se.call(this._minWeekdaysParse, i))
                    ? n
                    : null
                  : "dddd" === t
                  ? -1 !== (n = Se.call(this._weekdaysParse, i))
  ...
  function (e, t, a) {
    ...
    function x(e, t, a) {
      ...
      switch (e) {
        ...
        case "jMMM":
        case "jMMMM":
          b((n = s.localeData(a._l).jMonthsParse(t)))
            ? (a._isValid = !1)
            : (r[1] = n);
          break;
        case "jD":
    ...
    function W(e, t, a, n, i) {
      ...
      if (t) {
        ...
        (_ = O(m)),
          ...
          (t = "YYYY-MM-DD-" + m._f),
          (e =
            g(_[0], 4) + "-" + g(_[1] + 1, 2) + "-" + g(_[2], 2) + "-" + m._i);
      }
      return (
    ...
    function E(e) {
      var t = e._d;
      return e._isUTC
        ? J(t.getUTCFullYear(), t.getUTCMonth(), t.getUTCDate())
        : J(t.getFullYear(), t.getMonth(), t.getDate());
    }
    function z(e) {
      ...
      var s = (function (e, t, a) {
        ...
        return (function (e) {
          ...
          if ((s = e - d) >= 0) {
            if (s <= 185)
              return (
                (a = 1 + C(s, 31)), (t = I(s, 31) + 1), { jy: r, jm: a, jd: t }
              );
            s -= 186;
          } else (r -= 1), (s += 179), 1 === i.leap && (s += 1);
          return (
            (a = 7 + C(s, 30)), (t = I(s, 30) + 1), { jy: r, jm: a, jd: t }
          );
        })(G(e, t, a));
      })(e, t + 1, a);
      return (s.jm -= 1), s;
      ...
      var s = (function (e, t, a) {
        return V(
          (function (e, t, a) {
            var s = U(e);
            return (
              G(s.gy, 3, s.march) + 31 * (t - 1) - C(t, 7) * (t - 7) + a - 1
            );
          })(e, t, a)
        );
      })(e, t + 1, a);
    ...
    function U(e) {
      ...
      for (i = 1; i < _ && ((a = (t = d[i]) - m), !(e < t)); i += 1)
        (u = u + 8 * C(a, 33) + C(I(a, 33), 4)), (m = t);
      return (
        (u = u + 8 * C((r = e - m), 33) + C(I(r, 33) + 3, 4)),
        4 === I(a, 33) && a - r == 4 && (u += 1),
        (n = 20 + u - (C(o, 4) - C(3 * (C(o, 100) + 1), 4) - 150)),
        a - r < 6 && (r = r - a + 33 * C(a + 4, 33)),
        -1 === (s = I(I(r + 1, 33) - 1, 4)) && (s = 4),
        { leap: s, gy: o, march: n }
      );
    }
    function G(e, t, a) {
      var s =
        C(1461 * (e + C(t - 8, 6) + 100100), 4) +
        C(153 * I(t + 9, 12) + 2, 5) +
        a -
        34840408;
    ...
    function V(e) {
      ...
      return (
        (t =
          (t = 4 * e + 139361631) +
          4 * C(3 * C(4 * e + 183187720, 146097), 4) -
          3908),
        (a = 5 * C(I(t, 1461), 4) + 308),
        (s = C(I(a, 153), 5) + 1),
        (n = I(C(a, 153), 12) + 1),
        { gy: C(t, 1461) - 100100 + C(8 - n, 6), gm: n, gd: s }
      );
    }
    !(function () {
      for (var e; y.length; )
      ...
      (A.fn.isBefore = function (e, t) {
        return "jyear" === (t = v(t, this)) || "jmonth" === t
          ? s.fn.isBefore.call(this.clone().startOf(t), e.clone().startOf(t))
      ...
      (A.jDaysInMonth = function (e, t) {
        return (
          (e += C(t, 12)),
          (t = I(t, 12)) < 0 && ((t += 12), (e -= 1)),
          t < 6 ? 31 : t < 11 ? 30 : A.jIsLeapYear(e) ? 30 : 29
        );
      }),
      (A.jIsLeapYear = R),
      s.updateLocale("fa", {
      ...
      s.locale("en"),
      (A.jConvert = { toJalali: J, toGregorian: N });
  },
  function (e, t) {
